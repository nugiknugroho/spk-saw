...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <a href="jumlahdata.php" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px;"><i class="fa fa-plus"></i> Tambah</a>
    </div>
 ...
 <table class="table table-bordered table-striped">
            ...
            <?php 
                ...
                $query = mysqli_query($koneksi, "SELECT id_uji, nama_kriteria, nilai FROM tbl_uji, tabel_kriteria WHERE tbl_uji.id_kriteria = tabel_kriteria.id_kriteria");
                $no = 0 ;
