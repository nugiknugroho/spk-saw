...
<div class="card">  
                        <div class="card-header">
                            <strong class="card-title">Tabel Normalisasi</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
            ...
            <tbody id="list-itens">
                ...
                <?php
                    ...
                    while($dataAkhir = mysqli_fetch_array($sql2)){
                        echo "<tr><th>".$dataAkhir['nama_alt']."</th>";
                        $id_alternatif = $dataAkhir['id_alt'];  
                        $queryBaru = "SELECT * FROM saw3 WHERE saw3.id_alt = $id_alternatif ORDER BY `saw3`.`id_kriteria` ASC";
                            $sqlBaru = mysqli_query($koneksi,$queryBaru);
...
<div class="card">  
                        <div class="card-header">
                            <strong class="card-title">Tabel Hasil Perkalian</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
                    ...
                    while($dataAkhir = mysqli_fetch_array($sql2)){
                        ...
                        for($i=0; $i <mysqli_num_rows($sqlKriteria); $i++){
                            ...
                            $datafinal = mysqli_fetch_array($sqlBaru);
                                ...
                                echo "<th>".$datafinal['hasilkali']."</th>";
...
<div class="card">  
                        <div class="card-header">
                            <strong class="card-title">Tabel Hasil Akhir</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
            ...
            <tbody id="list-itens">
                ...
                <?php
                    ...
                    $data2 = "SELECT * FROM rangkingsaw ORDER BY rangkingsaw.hasil DESC";
                    $sql2 = mysqli_query($koneksi,$data2);  
                    

                    while($dataAkhir = mysqli_fetch_array($sql2)){
                        echo "<tr><th>".$dataAkhir['hasil']."</th>";
                        $id_alternatif = $dataAkhir['id_alt'];
