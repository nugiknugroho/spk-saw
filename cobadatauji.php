...
<body>
  ...
  <form method="GET" action="multi_insert_data.php">      
            ...
            <tbody id="list-itens">
                ...
                <tr>
                    <?php 
                     ...
                     ?>
                   <th>
                   <select name="nama_kriteria<?php echo $i?>" class="form-control">
                   ...
                   <th><input type="text" name="nilai<?php echo $i?>" class="form-control"
        placeholder="Inputkan Nilai"></th>
                </tr>
