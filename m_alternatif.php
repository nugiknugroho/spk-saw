...
<div class="container">
  ...
  <form method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nama_alt" class="form-control"
        placeholder="Inputkan Alternatif">
    </div>
 ...
 <!-- .content -->
    ...
    $query = mysqli_query($koneksi, "INSERT INTO tabel_alternatif VALUES(NULL, '$nama', '$keterangan')");

    if ($query > 0) {
        
        echo "<script>alert('Data Berhasil Ditambah');window.location.href='v_alternatif.php'</script>";
