...
<div class="container">
  ...
  <form method="POST">
    ...
    <button class="btn btn-primary" type="submit" name="tambah2">TAMBAH</button>
    </div>
</form>
</div>
        </div>
...
if (isset($_POST['tambah2'])) {
            ...
            $query = mysqli_query($koneksi, "INSERT INTO tabel_kriteria VALUES(NULL, '$nama', '$keterangan')");

        if ($query > 0) {
        
            echo "<script>alert('Data Berhasil Ditambah');window.location.href='v_kriteria.php'</script>";
