...
<div class="container">
  ...
  <form method="POST">
    <div class="form-group">
        <label>Alternatif</label><br>
            <select name="nama_alt">
                ...
                <option value="<?php echo $data['id_alt'];?>"><?php echo $data['nama_alt'];?></option>
                <?php } ?>
    ...
    <div class="form-group">
        <label>Kriteria</label><br>
            <select name="nama_kriteria">
                ...
                <option value="<?php echo $data['id_bobot'];?>"><?php echo $data['nama_kriteria'];?></option>
                <?php } ?>
    ...
    <button class="btn btn-primary" type="submit" name="tambah_nilai">TAMBAH</button>
    </div>
</form>
</div>
        </div>
 ...
 <!-- .content -->
  ...
  if (isset($_POST['tambah_nilai'])) {
        ...
        $alternatif = $_POST['nama_alt'];
        $kriteria = $_POST['nama_kriteria'];
        $nilai = $_POST['nilai'];

    $query = mysqli_query($koneksi, "INSERT INTO nilai(id_nilai, id_alt, id_bobot, nilai) VALUES(NULL, '$alternatif', '$kriteria', '$nilai')");

    if ($query > 0) {
        
        echo "<script>alert('Data Berhasil Ditambah');window.location.href='v_nilai.php'</script>";
