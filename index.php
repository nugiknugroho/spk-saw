                        ...
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="v_alternatif.php">Lihat Alternatif</a>

                                </div>
                            </div>
                        </div>
                       
                        <p class="text-light">Data Alternatif</p>
                ...
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="v_kriteria.php">Lihat Kriteria</a>

                                </div>
                            </div>
                        </div>
                       
                        <p class="text-light">Data Kriteria</p>
                ...
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="v_bobot.php">Lihat Bobot</a>

                                </div>
                            </div>
                        </div>
                       
                        <p class="text-light">Data Bobot</p>
                ...
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="v_nilai.php">Lihat Data Nilai</a>
                                    <a class="dropdown-item" href="cobasawview.php">Lihat Semua Data Metode SAW</a>
                                    <a class="dropdown-item" href="v_nilaiwp.php">Lihat Nilai Metode WP</a>

                                </div>
                            </div>
                        </div>
                       
                        <p class="text-light">Data Nilai</p>
                ...
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="datauji.php">Lihat Data Uji</a>
                                    <a class="dropdown-item" href="ujiuas.php">Lihat Data Hasil Uji</a>
                                </div>
                            </div>
                        </div>
                       
                        <p class="text-light">Data Uji</p>
