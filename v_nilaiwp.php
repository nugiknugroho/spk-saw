            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Semua Data Nilai Metode WP</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Semua Data Nilai Metode WP</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<!--NORMALISASI-->
                    ...
                    <div class="card">  
                        <div class="card-header">
                            <strong class="card-title">Tabel Normalisasi Bobot dan Vektor S</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
            ...
            <tbody id="list-itens">
                ...
                $data2 = "SELECT * FROM  vektorsnew ORDER BY vektorsnew.id_alt ASC";
                $sql2 = mysqli_query($koneksi,$data2);  
                    

                    while($dataAkhir = mysqli_fetch_array($sql2)){
                        $hasilS = $dataAkhir['hasil'];
                        echo "<tr><th>".round($hasilS, 2)."</th>";
                        $id_alternatif = $dataAkhir['id_alt'];
                        $queryBaru = "SELECT * FROM tabel_alternatif WHERE tabel_alternatif.id_alt = '$id_alternatif'";
                            $sqlBaru = mysqli_query($koneksi,$queryBaru);
                        
                            $datafinal = mysqli_fetch_array($sqlBaru);
                                echo "<th>".$datafinal['nama_alt']."</th>";
...
<div class="card">  
                        <div class="card-header">
                            <strong class="card-title">Tabel Vektor V dan Perangkingan Data</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
            ...
            <tbody id="list-itens">
                ...
                $data2 = "SELECT * FROM  hasilakhir ORDER BY hasilakhir.hasilsumvektor DESC";
                $sql2 = mysqli_query($koneksi,$data2);  
                    

                    while($dataAkhir = mysqli_fetch_array($sql2)){
                        $hasilV = $dataAkhir['hasilsumvektor'];
                        echo "<tr><th>".round($hasilV, 2)."</th>";
                        $id_alternatif = $dataAkhir['id_alt'];
                        $queryBaru = "SELECT * FROM tabel_alternatif WHERE tabel_alternatif.id_alt = '$id_alternatif'";
                            $sqlBaru = mysqli_query($koneksi,$queryBaru);
