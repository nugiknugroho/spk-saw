                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">INPUT MASUKKAN DATA</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="container">
  ...
  <form method="POST" action="cobadatauji.php">

    <div class="form-group">

         <label>Masukkan Jumlah Data Yang Di Input</label>
        <input type="text" name="angka" class="form-control"
        placeholder="Inputkan Jumlah Data">
