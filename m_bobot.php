...
<div class="container">
  ...
  <form method="POST">
    ...
    <button class="btn btn-primary" type="submit" name="tambah_bobot">TAMBAH</button>
    </div>
</form>
</div>
        </div>
 ...
 <!-- .content -->
   ...
   if (isset($_POST['tambah_bobot'])) {
        ...
        $query = mysqli_query($koneksi, "INSERT INTO bobot(id_bobot, id_kriteria, bobot) VALUES(NULL, '$kriteria', '$bobot')");

    if ($query > 0) {
        
        echo "<script>alert('Data Berhasil Ditambah');window.location.href='v_bobot.php'</script>";
