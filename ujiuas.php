...
<div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tabel Sinkron Uji</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
            ...
            <?php 
                ...
                $query = mysqli_query($koneksi, "SELECT id_nilai, tabel_alternatif.nama_alt, nilai, nilaiinput, hasilsaw, hasilsumvektor FROM tabel_alternatif,ujiuas WHERE ujiuas.id_alt=tabel_alternatif.id_alt");
                $no = 0 ;
                foreach ($query as $data) {
            ...
            <tbody id="list-itens">
                <tr>
                    ...
                    <th><?=$data['nama_alt']?></th>
                    <th><?=$data['nilai']?></th>
                    <th><?=$data['nilaiinput']?></th>
                    <th><?=$data['hasilsaw']?></th>
                    <th><?=$data['hasilsumvektor']?></th>
                </tr>
            <?php 
...
<div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tabel Perangkingan Max Uji</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
            ...
            <?php 
                ...
                $query = mysqli_query($koneksi, "SELECT id_nilai, tabel_alternatif.nama_alt, nilai, nilaiinput, hasilsaw, hasilsumvektor FROM tabel_alternatif,ujiuas_1 WHERE ujiuas_1.id_alt=tabel_alternatif.id_alt");
                $no = 0 ;
                foreach ($query as $data) {
...
<div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tabel Hasil Akhir Uji</strong>
                        </div>
                        <div class="card-body"> 
                            <table class="table">
                              <thead>
            ...
            <?php 
                ...
                $query = mysqli_query($koneksi, "SELECT id_nilai, tabel_alternatif.nama_alt, maxsaw, maxwp FROM tabel_alternatif, ujiuas2 WHERE ujiuas2.id_alt=tabel_alternatif.id_alt");
                $no = 0 ;
                foreach ($query as $data) {
